...
export default function Hero({ data }: HeroProps) {
  return (
    <section className="grid grid-cols-1 lg:grid-cols-2 gap-4">
      <div className="bg-white dark:bg-gray-900 rounded-2xl p-12 flex flex-col justify-center relative overflow-hidden">
        <div className="relative z-10">
          <h2 className="text-6xl font-extrabold text-primary dark:text-white leading-[1.1] mb-6">
          ...
          <Link
            href={data.ctaHref}
            className="bg-primary text-white px-8 py-4 rounded-full font-bold flex items-center gap-4 hover:opacity-90 transition-opacity w-fit"
          >
            {data.ctaText}{" "}
